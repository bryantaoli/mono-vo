...
public:
	...
	Mat                     descriptors_ref_;  // descriptor in ref frame 
...
public: // functions 
	...
	void triangulation(const vector< KeyPoint >& keypoint_1, const vector< KeyPoint >& keypoint_2, const std::vector< DMatch >& matches, const Mat& R, const Mat& t, vector< Point3f >& points);
protected:  
    // inner operation 
